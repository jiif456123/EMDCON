...
export const ROUTES: RouteInfo[] = [
    {
        path: '/administrarperfiles', title: 'Administrar Perfiles', icon: 'zmdi zmdi-home text-primary', class: '', badge: '', badgeClass: 'badge badge-success badge-pill float-right mr-1 mt-1', isExternalLink: false, 
        submenu: []
    },
    {
    ...
    {
        path: '/gestionarreporteeconomico', title: 'Gestionar Reporte Economico', icon: 'zmdi zmdi-home text-primary', class: '', badge: '', badgeClass: 'badge badge-success badge-pill float-right mr-1 mt-1', isExternalLink: false, 
        submenu: []
    },
    {
        path: '/consultarresidentemoroso', title: 'Consultar Residente Moroso', icon: 'zmdi zmdi-home text-primary', class: '', badge: '', badgeClass: 'badge badge-success badge-pill float-right mr-1 mt-1', isExternalLink: false, 
        submenu: []
    },
];
